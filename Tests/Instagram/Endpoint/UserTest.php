...
class UserTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @covers Eden\Instagram\Endpoint\User::getInfo
     */
    ...
    /**
     * @covers Eden\Instagram\Endpoint\User::getFeed
     */
    ...
    /**
     * @covers Eden\Instagram\Endpoint\User::getMediaRecent
     */
    public function testGetMediaRecent()
    {
        ...
        $response = $this->user->getMediaRecent(5, 1001331485, 1381331485);
    ...
    /**
     * @covers Eden\Instagram\Endpoint\User::getMediaLiked
     */
    public function testGetMediaLiked()
    {
        if (empty($this->token)) {
            return;
        }

        $response = $this->user->getMediaLiked(5);
    ...
    /**
     * @covers Eden\Instagram\Endpoint\User::search
     */
    public function testSearch()
    {
        ...
        $response = $this->user->search('ian', 5);
